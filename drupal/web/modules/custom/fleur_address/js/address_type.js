    ...
    Drupal.behaviors.address_type = {
        attach: function attach(context, settings) {
            ...
            var idList = {
                ...
                'profile_payment': {
                    wrapper         : '#edit-payment-method-billing-information-field-address-type',
                    company_field   : '.form-item-payment-method-billing-information-address-0-address-organization',
                    company_value   : '#edit-payment-method-billing-information-address-0-address-organization',
                },
                'order_payment': {
                    wrapper         : '#edit-billing-profile-0-profile-field-address-type',
                    company_field   : '.form-item-billing-profile-0-profile-address-0-address-organization',
                    company_value   : '#edit-billing-profile-0-profile-address-0-address-organization',
                },
                'shipping': {
